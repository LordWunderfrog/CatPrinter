...
Maintainer-oriented route reference (status codes, response shapes, ops notes).  
**Building a caller?** Start with [CALLERS.md](CALLERS.md) — contract only, plus which hostname to use.

Base URL examples:

- Local: `http://localhost:8080`
- Same host as add-on (HA package): `http://127.0.0.1:8080`
- Other LAN / self-hosted services: `http://home.lan:8080`
- Externally reachable or standalone clients: `https://print.wunderfrog.com`

...
**1.1.18** (`ha-addon/config.yaml`). On share after deploy + Rebuild/Update. Confirm in HA: **Settings → Apps → Cat Printer**.

Recent commits:

- (pending) 1.1.18 — Arctic without `url=` (was 422 timeout); RSS fallback; listing cache

...
COPY yhk_printer.py printer_service.py print_spool.py image_prep.py reddit_image.py api.py cat-printer.py markdown_renderer.py Lucon.ttf ./
# Keep the above in sync with scripts/addon-files.txt (pack manifest).
